...
var processEntries = function() {
    ...
    // var transactions = []; use this to start with empty user transactions data
    var transactions = [ // populating transactions array with 10 transactions as required
        {
            "transactionId": 1,
	...
	if (isValid == true) {
        users.push( {userName: email_address, password: password, transactions: transactions } ); // push new user object to array
