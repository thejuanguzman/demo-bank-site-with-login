...
function addTransaction(){ // updates the user.transactions array by adding new item
    // var html = "";
...
function renderAccountInfo(){
    ...
    users.forEach(function (user) { // run foreach on array to check values keys
        ...
        var finalTotals = runningTotal.reduce((a, b) => a + b)
        alert(finalTotals);
